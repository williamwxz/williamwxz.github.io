...
Static GitHub Pages portfolio site for William Zhang, an AI and Data Infrastructure Engineer. No build system, no dependencies — everything is plain HTML/CSS/Markdown deployed directly via GitHub Pages.
